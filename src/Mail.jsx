  ...
  return (
    <>
      <section className="w-full flex justify-center mt-32 mb-32">
        <div className="bg-mail bg-no-repeat bg-center bg-cover lg:gap-0 gap-4 w-11/12 lg:w-9/12 lg:h-72 h-full lg:py-0 py-10 flex flex-col-reverse items-center lg:flex-row lg:justify-between px-6 lg:px-32">
          <div className="flex flex-col justify-center gap-4">
            ...
            <div className=" relative">
              ...
              <button className="bg-primary text-white p-[6px] rounded-lg absolute right-3 top-2 shadow-lg shadow-primary hover:-translate-y-1 transition-all">
